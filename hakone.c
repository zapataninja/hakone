...
/*        M1 - Right Base Back (IME)                                         */
/*        M2 - Right Arm                                                     */
/*        M3 - Left Base Front                                               */
/*        M4 - UNUSED                                                        */
/*        M5 - Right Base Front                                              */
/*        M6 - Claw Moter                                                    */
/*        M7 - Belly Loader Right                                            */
/*        M8 - Belly Loader Left (IME - Installed but not powered)           */
/*        M9 - Left Arm                                                      */
/*        M10 - Left Base Back (IME)                                         */
/*                                                                           */
/*                                                                           */
/*---------------------------------------------------------------------------*/
...
task get_sensor_data() {
	...
	while(1) {
		...
		sprintf(string1, "%1.2f%c", nImmediateBatteryLevel/1000.0,'V'); //Build the value to be displayed
		displayNextLCDString(string1);

		//Display the Backup battery voltage
		displayLCDString(1, 0, "Arm: ");
		sprintf(string2, "%1.2f%c", ((float)SensorValue[M2]/280), 'V');	//Build the value to be displayed
		...
		sprintf(string1, "%d Rtns", abs(nMotorEncoder[M1]));	//Build the value to be displayed
		displayNextLCDString(string1);


		displayLCDString(1, 0, "LM: ");
		sprintf(string2, "%d Rtns", abs(nMotorEncoder[M10]));	//Build the value to be displayed
		displayNextLCDString(string2);
		wait1Msec(3000);
		...
		sprintf(string1, "%d CMs", SensorValue(sonar));	//Build the value to be displayed
		displayNextLCDString(string1);
		wait1Msec(3000);
		*/
